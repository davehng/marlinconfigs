 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 24   // don't crash into the right side due to hemera
  #define PROBING_MARGIN_FRONT PROBING_MARGIN
  #define PROBING_MARGIN_BACK 42    // don't crash into the back due to hemera
#endif
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PROBE_POS  { 127.5F, 106.3F }
 ...
 */
   ...
   */
  #define STEALTHCHOP_XY  // stealthchop for hold, spreadcycle for move
...
//#define CHOPPER_TIMING { 2, 2, 0 }
//#define CHOPPER_TIMING { 1, -1, 4 } 
